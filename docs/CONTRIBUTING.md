...
experience the problem? What would you expect to be the outcome? All these details will help people
...
Open Bugs here: https://github.com/archerysec/archerysec/issues
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream https://github.com/archerysec/archerysec.git
   ```
